...
//
//alias _s_poller_t s_poller_t;
//alias _s_timer_t s_timer_t;
//alias _zloop_t zloop_t;
//
...
//        *self;
//
//    self = cast(zloop_t *) zmalloc (zloop_t.sizeof);
//    if (self) {
...
//
//    s_poller_t *poller = cast(s_poller_t *) zlist_first (self.pollers);
//    while (poller) {
...
//            self.dirty = TRUE;
//        }
//        poller = cast(s_poller_t *) zlist_next (self.pollers);
//    }
//    if (self.verbose)
...
//    s_timer_t *timer = cast(s_timer_t *) zlist_first (self.timers);
//    while (timer) {
//        timer.when = timer.delay + zclock_time ();
//        timer = cast(s_timer_t *) zlist_next (self.timers);
//    }
//    //  Main reactor loop
...
//                break;
//        }
//        rc = zmq_poll (self.pollset, cast(int) self.poll_size,
...
//        timer = cast(s_timer_t *) zlist_first (self.timers);
//        while (timer) {
